...
class ReplaceVersionsTests: LHCTestCase {
    ...
    func verifyFileContents(
        ...
        guard let textContents = LHC.fileManager.contents(atPath: "\(Self.repoPath)/version.txt"),
        ...
        guard let jsonContents = LHC.fileManager.contents(atPath: "\(Self.repoPath)/version.json"),
        ...
        guard let yamlContents = LHC.fileManager.contents(atPath: "\(Self.repoPath)/version.yaml"),
        ...
        guard let plistContents = LHC.fileManager.contents(atPath: "\(Self.repoPath)/version.plist"),
    ...
    func testReplaceVersionsWithDerivedVersion() throws {
        ...
        let fileManager = LHC.fileManager // save FM state
        ...
        LHC.fileManager = fileManager // restore FM state
