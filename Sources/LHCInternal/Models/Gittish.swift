...
extension Repositoryish {
    ...
    public func commits(on branch: Branchish, since start: ObjectID?) throws -> [Commitish] {
    ...
    public func commits(from oid: ObjectID, since start: ObjectID?) throws -> [Commitish] {
...
open class CommitishIterator: IteratorProtocol, Sequence {
    var wrappedValue: CommitIterator?

    public typealias Element = Result<Commitish, Error>
    public typealias Iterator = CommitishIterator

    public init(_ wrappedValue: CommitIterator?) {
