...
extension Version {
    public var shortVersion: Self {
        Version(major, minor, patch)
    }

    public func prereleaseIdentifier(after identifier: String?) -> String {
    ...
    public func bumpingPrerelease(channel: String) -> Self {
    ...
    public func bumping(_ bump: ConventionalCommit.VersionBump) -> Self {
        switch bump {
    ...
    public init?(prefix: String?, versionString: String) {
